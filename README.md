...
- [版本变更记录](CHANGELOG.md)
- [当前状态与新会话交接](docs/current-state.md)
- [现行架构与程序职责规范](docs/architecture.md)
- [独立 Agent 快速开始](docs/independent-agent-quickstart.md)
- [架构、运行流程与功能边界](docs/system-overview.md)
- [Desktop IDE 使用说明](docs/desktop-ide.md)
- [Agent 集成说明](docs/agent-integration.md)
- [知识治理](docs/knowledge-governance.md)
- [Qualification 与证据边界](docs/qualification.md)
- [公开与私有资产分发边界](docs/design/distribution-asset-boundary.md)
- [历史设计、计划与阶段报告索引](docs/archive/README.md)
- [许可证](LICENSE)
- [来源与声明](NOTICE.md)
