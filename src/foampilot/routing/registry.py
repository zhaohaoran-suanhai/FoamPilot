...
SOLVER_CAPABILITIES: dict[str, SolverCapability] = {
    ...
    "compressibleInterFoam": SolverCapability(
        family="compressible-vof",
        regime="transient",
        compressibility="compressible",
        phase_family="vof",
        energy="enabled",
    ),
    "driftFluxFoam": SolverCapability(
        family="drift-flux",
        regime="transient",
        compressibility="incompressible",
        phase_family="multiphase",
        energy="disabled",
    ),
    "multiphaseEulerFoam": SolverCapability(
        family="multiphase-euler",
        regime="transient",
        compressibility="compressible",
        phase_family="multiphase",
        energy="enabled",
    ),
    "dsmcFoam": SolverCapability(
        family="rarefied-gas",
        regime="transient",
        compressibility="compressible",
        phase_family="single_phase",
    ...
    "denseParticleFoam": SolverCapability(
        family="dense-particle",
        regime="transient",
        compressibility="incompressible",
        phase_family="multiphase",
        energy="disabled",
    ),
    "reactingFoam": SolverCapability(
        family="compressible-reacting",
        regime="transient",
        compressibility="compressible",
        phase_family="single_phase",
        energy="enabled",
